...
function Contact() {
  ...
  return (
    <div id="contact" className="pt-[75px] px-[15px]">
      ...
      <div className="flex justify-center ml-[20px] flex-col gap-[35px] mt-[80px]  lg:flex-row lg:gap-[190px] mb-[40px]">
      ...
      <footer>
        ...
        <h1 className="text-[#fff]  flex items-center justify-center pt-[60px]">ExspressTrade.ge</h1>

        <p className="text-[#E3B81E] text-[15px] flex items-center justify-center pt-[10px]">Stay in touch with us</p>
        {/* <div className="flex justify-center items-center gap-[15px] mt-[20px]">
        <img src={Facebook} alt="" />
        <img src={Instagram} alt="" />
        </div> */}
        <div className="flex justify-center items-center mt-[20px]">
          <h1 className="text-[#E3B81E]"><span className="text-[#fff]">Made by </span><a href="https://www.weblance.ge/" target="_blank">@webLance</a></h1>
        </div>
        </div>
      </footer>
    </div>
