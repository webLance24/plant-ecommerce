  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center text-[30px] mt-[20px]">
        <h1 className="text-[#444444]">Learn More <span className="text-[#E43C5C]">About US</span></h1>
      </div>
      ...
      <div className="flex-wrap justify-center items-center mt-[40px] px-[10px]">
        ...
        <p>Ullamco laboris nisi ut aliquip ex ea commodo consequat.
          ...
          <div className="mt-[20px]">
            <p className="flex items-center justify-center gap-[5px]"><img src={Rice} alt=""  className="w-[25px] h-[25px]"/>Ullamco laboris nisi ut aliquip ex ea commodo consequat</p>
            <p className="flex items-center justify-center gap-[5px]"><img src={Rice} alt="" className="w-[25px] h-[25px]"/>Ullamco laboris nisi ut aliquip ex ea commodo consequat</p>
            <p className="flex items-center justify-center gap-[5px]"><img src={Rice} alt="" className="w-[25px] h-[25px]"/>Ullamco laboris nisi ut aliquip ex ea commodo consequat</p>
          </div>
      </div>
